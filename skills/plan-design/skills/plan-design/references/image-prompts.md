...
Use these templates when building DALL-E prompts in Phase 2. Fill every placeholder with real values from DESIGN.md and the alignment interview.
...
- "UI mockup screenshot" — tells DALL-E this is interface design, not illustration
...
- **One call per archetype** — DALL-E n=1 produces more coherent results than n=3 at once
